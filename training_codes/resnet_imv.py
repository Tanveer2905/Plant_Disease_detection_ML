...
model_ckpt = ModelCheckpoint('models/best_resnet50.h5', save_best_only=True, monitor='val_accuracy', verbose=1)
...
# ==== Save Final Model as .keras ====
resnet_model.save('models/resnet50_finetuned.keras')
print("✅ Final model saved at 'models/resnet50_finetuned.keras'")
...
plt.savefig('reports/resnet50_training_plots.png')

plt.show()

# ==== Evaluation ====
true_labels = val_set.classes
predictions = np.argmax(resnet_model.predict(val_set), axis=1)
...
plt.savefig('reports/resnet50_confusion_matrix.png')
plt.show()

# Classification Report
print("\nClassification Report:\n")
classification_report_str = classification_report(true_labels, predictions, target_names=class_names)
